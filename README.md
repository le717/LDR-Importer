...
All releases from version v1.0 onward are available on the [Releases](https://github.com/le717/LDR-Importer/releases) page.
All previous releases are available on le717's personal 
[SourceForge.net account](http://sourceforge.net/projects/le717.u/files/Blender/Blender%202.6%20LDraw%20Importer/). It is always recommended to use the newest release unless otherwise noted.
...
Guidelines to help you contribute to **LDR Importer** can be found on the [Wiki](https://github.com/le717/LDR-Importer/wiki).
# Contributors #
